...
// Main Component
const AffiliateWebsiteUSA = ({ onChangeCountry }) => {
  const [searchTerm, setSearchTerm] = useState('');

  const filteredProducts = useMemo(() => {
    if (!searchTerm.trim()) return productsUSA;
    
    return productsUSA.filter(product =>
      ...
      <header className="bg-white shadow-lg">
        <div className="container mx-auto px-2 py-4">
          ...
          <div className="flex justify-center items-center mt-4 space-x-2">
            ...
            <span className="text-sm text-gray-600">Shopping from USA</span>
            <button
...
export default AffiliateWebsiteUSA;